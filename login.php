...
if(mysqli_query($con , "INSERT INTO signin ( username , password ) VALUES ('$_POST[name]','$_POST[password]')"))
   {
        ...
        <div class="row" id="row1"> 
            ...
            <div class="contact-col">
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST" class="contact-form" >
                    ...
                    <input type="text" id="name" name="name" value="<?php if(isset($_REQUEST['name'])) { echo $_REQUEST['name']; } ?>" required><br>
                    <label for="password">Password:</label><br>
                    <input type="password" id="password" name="password" value="<?php if(isset($_REQUEST['password'])) { echo $_REQUEST['password']; } ?>" required>
                    <button type="submit" class="hbutton red-button">Log In</button>

<!-- Enter first Name: <input type=text name=fname value="<?php if(isset($_REQUEST['fname'])) { echo $_REQUEST['fname']; } ?>"  /><br /> -->
        ...
        <!-- <div class="row" id="row2" >
            ...
            <div class="contact-col">
                ...
                <form action="form_handler.php" method="POST" class="contact-form">
                    ...
                    <textarea rows="8" id="address" name="address"  required></textarea>
                    <br>
